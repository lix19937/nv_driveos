...
public:
    ...
    bool Init(char *filename)
    {
        ...
        if (ParseConfig(&config, filename) != 0)
        {
...
private:
    ...
    SetSurfaceConfig(SurfaceAttrs *attrs, const ConfigFileSurfaceAttrs *conf)
    {
        ...
        printf(">>>>> firstPlaneHasColorStd=%s\n", firstPlaneHasColorStd ? "TRUE" : "FALSE");
    ...
    ReadWritePixelDataLineByLine(NvSciBufObj sciBuf, PixelDataBuffer *px, bool write)
    {
        ...
        for (uint32_t plane = 0; plane < px->planeCount; ++plane)
        {
            ...
            printf(">>> %10lu  %10u  %10u %10u\n", sciBufPlaneOffset, sciBufPlanePitch, planeHeight, px->planePitches[plane]);
...
int main(int argc, char **argv)
{
    ...
    Img_2D img2d;
    if (!img2d.Init(argv[1]))
    {
        LOG_ERR("Init failed, configfile", argv[1]);
        return 1;
    }
    printf("\n --------- Run --------- \n");
    ...
    if (!img2d.Run())
    {
        LOG_ERR("Run failed, configfile", argv[1]);
        return 1;
    }
...
/home/lix/workspace/6060-drive/toolchains/aarch64--glibc--stable-2022.03-1/bin/aarch64-buildroot-linux-gnu-g++  \
...
image_2d.cpp                         \
/home/lix/workspace/6060-drive/drive-linux/samples/nvmedia_6x/utils/config_parser.c \
/home/lix/workspace/6060-drive/drive-linux/samples/nvmedia_6x/utils/log_utils.c \
-I/home/lix/workspace/6060-drive/drive-linux/samples/nvmedia_6x/utils  \
-I/home/lix/workspace/6060-drive/drive-linux/include/nvmedia_6x \
-I/home/lix/workspace/6060-drive/drive-linux/include            \
-L/home/lix/workspace/6060-drive/drive-linux/lib-target         \
-L/home/lix/workspace/6060-drive/drive-linux/lib-target/x11     \
-Wl,-rpath-link=/home/lix/workspace/6060-drive/drive-linux/lib-target \
-Wl,-rpath-link=/home/lix/workspace/6060-drive/drive-linux/lib-target/x11 \
-Wl,--dynamic-linker=/lib/ld-linux-aarch64.so.1 \
-lnvmedia2d -lnvscibuf -lnvscisync  -o image_2d_cpp
